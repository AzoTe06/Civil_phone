...
function phoneMenu()
    ...
    Menu.addButton("Fermer le téléphone", "closePhone", nil)
end
...
function repertoryMenu()
    ...
    Menu.addButton("Contacts", "contact", nil )    
...
function contact()
    options.menu_subtitle = "Contacts"
    ClearMenu()
...
function repertoryContact(contact)
    ...
    Menu.addButton('Retour', 'contact', nil )
end

----------- NUMBER -----------

function number(contact)
    TriggerServerEvent("phone:number", {identifier = contact})
end
...
function deleteContact(contact)
    options.menu_subtitle = "Supprimer le contact"
    ClearMenu()
    Menu.addButton("Oui", "deleteContact2", nil)
    Menu.addButton("Non", "contact", nil )
end

function deleteContact2(contact)
...
function msgMenu(msg)
    ...
    TriggerServerEvent("phone:messageryGetOldMsg")
    options.menu_subtitle = "Message de ~g~"..msg.name
    ClearMenu()
